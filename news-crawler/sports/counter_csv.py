...
writefile = open("/home/foo/pypy/text-master/news-crawler/sports/theguardian.csv", 'wb')
...
file = open('/home/foo/pypy/text-master/news-crawler/sports/theguardian.txt', 'r')
