...
def remove_stopwords( filename ):
    ...
    out =  open(filename + '_.txt', 'a')

    word_list = text.split()
    nonstop_list =  [word for word in word_list if word.lower() not in stopwords]
    out.write(' '.join(nonstop_list))



remove_stopwords('sport')
remove_stopwords('tech')
